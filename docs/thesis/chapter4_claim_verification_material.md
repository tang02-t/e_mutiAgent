...
- 声明 schema 与约束正反例：[claim_schema.md](../design/claim_schema.md)
- 核查器实现：[claim_checker.py](../../src/agents/claim_checker.py)；集成：[validator.py](../../src/agents/validator.py)；路由：[workflow.py](../../src/graph/workflow.py)
- C-2 确定性层验收：[claim_checker_acceptance.md](../eval/claim_checker_acceptance.md)
- C-3 路由验收：[route_acceptance.md](../eval/route_acceptance.md)
- D11 数据卡片：[DATA_CARD.md](../../data/eval/d11/DATA_CARD.md)
- C-5 对照实验：[validator_eval.md](../eval/validator_eval.md)，图 [fig_c5_detection_by_type.png](../figures/fig_c5_detection_by_type.png)、[fig_c5_pass_vs_cost.png](../figures/fig_c5_pass_vs_cost.png)
