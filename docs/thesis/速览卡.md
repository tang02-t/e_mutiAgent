...
> 2026-09-17 · 代码 `0128d32` · PLAN 进度 79 / 113 · 5 分钟读完。详情见 [技术报告_v2.md](技术报告_v2.md)，看数据怎么流转见 [walkthrough_traces.md](../eval/walkthrough_traces.md)。
...
| 5 | 撤销重建历史泄漏的百炼 API Key（`sk-9acc…`）；F 收尾：架构 PNG 重绘、`v2-final` tag、已知局限、论文 3-6 章初稿 | 5 分钟 + 数天 | 安全、成果固化 |
...
进度看 [PLAN_优化计划清单.md](../../PLAN_优化计划清单.md) §0.6 进度表与各小节 `[ ]` 项；架构看 [README.md](../../README.md)「项目架构」；改代码看 [PROJECT_OVERVIEW.md](../../PROJECT_OVERVIEW.md) §9；数据看 [data_and_evaluation.md](../design/data_and_evaluation.md)；跑一遍看 `bash reproduce.sh`。
