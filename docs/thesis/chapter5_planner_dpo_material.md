...
数据侧已确定：D13-exec / D13-full 有效偏好对数、平均分差、人工复核方向正确率、泄漏 0（demo 管线验收见 [DATA_CARD.md](../../data/planner/dpo/DATA_CARD.md)；正式数字待 M1 部署后候选生成）。

## 5.8 素材来源

- 打分、配对、导出、泄漏检查：[score_candidates.py](../../scripts/planner_data/score_candidates.py)；自检：[test_d2_preference_pairs.py](../../tests/test_d2_preference_pairs.py)
- 百炼训练封装与超参：[submit_job.py](../../training/planner_bailian/submit_job.py)、[README.md](../../training/planner_bailian/README.md)
- SFT 数据格式与封存：[bailian_format.py](../../scripts/planner_data/bailian_format.py)、[SEALED.md](../../data/planner/sft/SEALED.md)
- D13 数据卡片：[DATA_CARD.md](../../data/planner/dpo/DATA_CARD.md)；demo 汇总：[summary_demo.json](../../data/planner/dpo/summary_demo.json)
- 声明核查器（`faith` 分项依赖）：[claim_checker.py](../../src/agents/claim_checker.py)；第 4 章素材：[chapter4_claim_verification_material.md](chapter4_claim_verification_material.md)
