...
**验收判定（确定性层）：通过**（要求检出率 100%、误报 0）。样例定义见 [tests/test_c2_claim_checker.py](/Users/ts/Desktop/thu/multi_Agent/tests/test_c2_claim_checker.py)，正反例与 `docs/claim_schema.md` §4 对应。
