...
用法：
    python3 scripts/probe_llm_endpoint.py            # 读取 config.yaml 中 llms.default
    DASHSCOPE_API_KEY=sk-xxx python3 scripts/probe_llm_endpoint.py --key-env DASHSCOPE_API_KEY
"""
import argparse
import json
import os
